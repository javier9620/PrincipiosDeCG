...
void linea(int x0, int y0, int x1, int y1)
{
	...
	int d = (2 * dy) - dx;
	Application::getInstance()->putPixel(x0, y0, 255, 255, 0,255);
	int x = x0 + 1, y = y0;
	while (x <= x1)
	{
		if (d > 0)
		{
			...
			d += E;
		Application::getInstance()->putPixel(x, y, 255, 255, 0, 255);
		++x;
	}
}
...
void Application::init()
{
	...
	GLfloat vertices[]
	{
		...
		1.0f, -1.0f, 0.0f, 1.0f, //abajo derechaque
		...
		1.0f, -1.0f, 0.0f, 1.0f, //abajo derecha

		1.0f, 1.0f, 0.0f, 1.0f, //arriba derecha
	};
	GLfloat texCoords[] 
	{
...
void Application::draw()
{
	...
	//	{
	//		putPixel(i, j, 255, 255, 0,255);
	//	}
	//for (int i = 50; i--;)
	//{
	//	for (int j = 50; j--;)
	//		putPixel(i, j, 255, 25, 0, 255);
	//}
	for (int i = 0; i < 1024; ++i)
	{
		putPixel(i, 1, 0, 255, 255, 255);
		//putPixel(767, i, 0, 255, 255, 255);
	}
